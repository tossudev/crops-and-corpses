...
public partial class BuildingMode : Node2D
{
    ...
    public int buildingPriceLogs, buildingPriceStone, buildingPriceCopper;
    ...
    public override async void _Process(double delta)
    {
        ...
        if(!StorageData.ExistsInInventoryOrHotbar(buildingMenu.log.ID, buildingPriceLogs) || 
            !StorageData.ExistsInInventoryOrHotbar(buildingMenu.stone.ID, buildingPriceStone) ||
            !StorageData.ExistsInInventoryOrHotbar(buildingMenu.copper.ID, buildingPriceCopper))
        {
